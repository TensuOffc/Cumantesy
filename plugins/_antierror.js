...
handler.all = async function (m) {
    ...
    if ((user.money * 1) > 9999999999999999) {
        user.money = 9999999999999999
    ...
    if ((user.limit * 1) > 9999999999999999) {
         user.limit = 9999999999999999
    } else if ((user.limit * 1) < 0) {
         user.limit = 0
    }
    if ((user.bank * 1) > 9999999999999999) {
         user.bank = 9999999999999999
    ...
    if ((user.tuna * 1) > 1000000) {
        user.tuna = 1000000
    } else if ((user.tuna * 1) < 0) {
        user.tuna = 0
    }
