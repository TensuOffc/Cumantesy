let handler = async (m, {
  conn, usedPrefix, command, text, args
}) => {
  ...
  switch (type) {
    case 'easy':
      ...
      if (new Date - global.db.data.users[m.sender].lastmancingeasy > 3600000) {
...
*🐡 = [ ${zero5} ]*			   *🐋 = [ ${zero1} ]*
            ...
            global.db.data.users[m.sender].tuna += rbrb11
            global.db.data.users[m.sender].orca += rbrb12
            global.db.data.users[m.sender].limit += 8
    ...
    case 'normal':
      ...
      let _timerl = (3600000 - __timerl)
      let timerl = clockString(_timerl)
      if (pancingan == 0 || umpan == 0) return m.reply('*Kamu belum memiliki Pancingan dan Umpan, Silahkan beli dulu..*')
      if (new Date - global.db.data.users[m.sender].lastmancingeasy > 3600000) {
        if (global.db.data.users[m.sender].pancingan > 2) {
          if (global.db.data.users[m.sender].umpan > 299) {
            let randomakud1 = `${Math.floor(Math.random() * 80)}`
            let randomakud2 = `${Math.floor(Math.random() * 80)}`
            let randomakud3 = `${Math.floor(Math.random() * 80)}`
            let randomakud4 = `${Math.floor(Math.random() * 80)}`
            let randomakud5 = `${Math.floor(Math.random() * 80)}`
            let randomakud6 = `${Math.floor(Math.random() * 80)}`
            let randomakud7 = `${Math.floor(Math.random() * 80)}`
            let randomakud8 = `${Math.floor(Math.random() * 80)}`
            let randomakud9 = `${Math.floor(Math.random() * 80)}`
            let randomakud10 = `${Math.floor(Math.random() * 80)}`
            let randomakud11 = `${Math.floor(Math.random() * 80)}`
            let randomakud12 = `${Math.floor(Math.random() * 80)}`
            ...
            let hsls = `
*《 Hasil Memancing Normal Kali Ini 》*
*🦀 = [ ${aine2} ]*			   *🐠 = [ ${aine6} ]*
*🦞 = [ ${aine8} ]*			   *🐟 = [ ${aine11} ]*
*🦐 = [ ${aine10} ]*		   *🐬 = [ ${aine7} ]*
*🦑 = [ ${aine4} ]*			   *🐳 = [ ${aine12} ]*
...
*🐡 = [ ${aine5} ]*			   *🐋 = [ ${aine1} ]*
            ...
            global.db.data.users[m.sender].tuna += rbrbs11
            ...
            user.lastmancingeasy = new Date * 1
          } else conn.reply(m.chat, 'Minimal umpan kamu *300* untuk memancing level normal', m)
    ...
    case 'hard':
      ...
      let _timerh = (10800000 - __timerh)
      let timerh = clockString(_timerh)
      if (pancingan == 0 || umpan == 0) return m.reply('*Kamu belum memiliki Pancingan dan Umpan, Silahkan beli dulu..*')
      if (new Date - global.db.data.users[m.sender].lastmancingeasy > 10800000) {
        if (global.db.data.users[m.sender].pancingan > 3) {
          if (global.db.data.users[m.sender].umpan > 999) {
            let randomakur1 = `${Math.floor(Math.random() * 200)}`
            let randomakur2 = `${Math.floor(Math.random() * 200)}`
            let randomakur3 = `${Math.floor(Math.random() * 200)}`
            let randomakur4 = `${Math.floor(Math.random() * 200)}`
            let randomakur5 = `${Math.floor(Math.random() * 200)}`
            let randomakur6 = `${Math.floor(Math.random() * 200)}`
            let randomakur7 = `${Math.floor(Math.random() * 200)}`
            let randomakur8 = `${Math.floor(Math.random() * 200)}`
            let randomakur9 = `${Math.floor(Math.random() * 200)}`
            let randomakur10 = `${Math.floor(Math.random() * 200)}`
            let randomakur11 = `${Math.floor(Math.random() * 200)}`
            let randomakur12 = `${Math.floor(Math.random() * 200)}`
            let randomakur13 = `${Math.floor(Math.random() * 200)}`
...
*🐡 = [ ${aines5} ]*			 *🐋 = [ ${aines1} ]*
            ...
            global.db.data.users[m.sender].tuna += rbrbsh11
            ...
            user.lastmancingeasy = new Date * 1
          } else conn.reply(m.chat, 'Minimal umpan kamu *1000* untuk memancing level hard', m)
    ...
    case 'extreme':
      ...
      let _timere = (18000000 - __timere)
      let timere = clockString(_timere)
      if (pancingan == 0 || umpan == 0) return m.reply('*Kamu belum memiliki Pancingan dan Umpan, Silahkan beli dulu..*')
      if (new Date - global.db.data.users[m.sender].lastmancingeasy > 18000000) {
        if (global.db.data.users[m.sender].pancingan > 4) {
          if (global.db.data.users[m.sender].umpan > 4999) {
            let randomakue1 = `${Math.floor(Math.random() * 800)}`
            let randomakue2 = `${Math.floor(Math.random() * 800)}`
            let randomakue3 = `${Math.floor(Math.random() * 800)}`
            let randomakue4 = `${Math.floor(Math.random() * 800)}`
            let randomakue5 = `${Math.floor(Math.random() * 800)}`
            let randomakue6 = `${Math.floor(Math.random() * 800)}`
            let randomakue7 = `${Math.floor(Math.random() * 800)}`
            let randomakue8 = `${Math.floor(Math.random() * 800)}`
            let randomakue9 = `${Math.floor(Math.random() * 800)}`
            let randomakue10 = `${Math.floor(Math.random() * 800)}`
            let randomakue11 = `${Math.floor(Math.random() * 800)}`
            let randomakue12 = `${Math.floor(Math.random() * 800)}`
            let randomakue13 = `${Math.floor(Math.random() * 800)}`
            ...
            let hslse = `
*《 Hasil Memancing Extreme Kali Ini 》*
*🦀 = [ ${ainese2} ]*		   	 *🐠 = [ ${ainese6} ]*
*🦞 = [ ${ainese8} ]*			 *🐟 = [ ${ainese11} ]*
*🦐 = [ ${ainese10} ]*			 *🐬 = [ ${ainese7} ]*
*🦑 = [ ${ainese4} ]*			 *🐳 = [ ${ainese12} ]*
...
*🐡 = [ ${ainese5} ]*		   	 *🐋 = [ ${ainese1} ]*
            ...
            global.db.data.users[m.sender].tuna += rbrbshe11
