const jobs = {
    ojek: [{ name: 'Ojek', task: '🛵 Mengantarkan penumpang', difficulty: pickRandom(['Noob', 'Easy', 'Normal']), money: randomMoney(350000, 1), exp: 500000 }],
    pedagang: [{ name: 'Pedagang', task: '🛒 Mencari pembeli', difficulty: pickRandom(['Noob', 'Easy', 'Normal']), money: randomMoney(350000, 1), exp: 500000 }],
    dokter: [{ name: 'Dokter', task: '💉 Merawat pasien', difficulty: pickRandom(['Easy', 'Normal', 'Hard']), money: randomMoney(350000, 1), exp: 500000 }],
    petani: [{ name: 'Petani', task: '🌾 Menanam dan memanen tanaman', difficulty: pickRandom(['Noob', 'Easy', 'Normal']), money: randomMoney(350000, 1), exp: 500000 }],
    montir: [{ name: 'Montir', task: '🔧 Memperbaiki kendaraan', difficulty: pickRandom(['Easy', 'Normal', 'Hard']), money: randomMoney(350000, 1), exp: 500000 }],
    kuli: [{ name: 'Kuli', task: '🏋️ Membantu proyek konstruksi', difficulty: 'Extreme', money: randomMoney(350000, 1), exp: 500000 }],
    gamer: [{ name: 'Gamer', task: '🎮 Main game dan streaming', difficulty: pickRandom(['Noob', 'Easy', 'Normal', 'Hard']), money: randomMoney(350000, 1), exp: 500000 }],
    teacher: [{ name: 'Teacher', task: '👩‍🏫 Mengajar dan memberi pembelajaran', difficulty: pickRandom(['Noob', 'Easy', 'Normal', 'Hard']), money: randomMoney(350000, 1), exp: 500000 }],
    designer: [{ name: 'Graphic Designer', task: '🎨 Membuat desain grafis', difficulty: pickRandom(['Easy', 'Normal', 'Hard']), money: randomMoney(350000, 1), exp: 500000 }],
};
...
function clockString(ms) {
    ...
    return ['' + d, ' *Days ☀️* ', h, ' *Hours 🕐* ', m, ' *Minute ⏰* ', s, ' *Second ⏱️* '].map(v => v.toString().padStart(2, 0)).join('');
}
